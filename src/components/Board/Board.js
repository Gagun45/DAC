      ...
      '>
        {boardHeroes.map((hero) => {
          ...
          return (
            ...
            <>
              <div key={hero.name}
                className={`hero-item-board animate-opacity0to1 rounded-t-3xl flex flex-col items-center justify-start overflow-hidden flex-wrap p-[0.2rem] gap-[0.2rem] w-[12%] md:w-[14%] lg:w-[18%]
                  ${hero.cost}`}
